import { NameSellerValueObject } from './name.value-object';

describe('name value object', () => {
  let objectValue: NameSellerValueObject;
  beforeEach(() => {
    //Arrange and Act
    objectValue = new NameSellerValueObject('name');
  });
  it('puede ser creado', () => {
    //Assert
  ...
  describe('validaciones', () => {
    it('si se le pasa un valor vació me da error', () => {
      ...
      //Act
      const objectValue = new NameSellerValueObject(name);
    ...
    it('si contiene alguna palabra prohibida me da error', () => {
      ...
      //Act
      const objectValue = new NameSellerValueObject(description);
      const result = objectValue.hasErrors();
