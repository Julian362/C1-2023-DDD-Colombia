import { DescriptionCategoryValueObject } from './description.value-object';

describe('descripción de la categoría value object', () => {
  let objectValue: DescriptionCategoryValueObject;
  beforeEach(() => {
    //Arrange and Act
    objectValue = new DescriptionCategoryValueObject('description');
  });
  it('puede ser creado', () => {
    //Assert
  ...
  describe('validaciones', () => {
    it('si se le pasa un valor vació me da error', () => {
      ...
      //Act
      const objectValue = new DescriptionCategoryValueObject(description);
