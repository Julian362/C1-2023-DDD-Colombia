import { StateCategoryValueObject } from './state.value-object';

describe('state value object', () => {
  let objectValue: StateCategoryValueObject;
  beforeEach(() => {
    //Arrange and Act
    objectValue = new StateCategoryValueObject(true);
  });
  it('puede ser creado', () => {
    //Assert
  ...
  describe('validaciones', () => {
    it('si le paso un booleano no me da error', () => {
      ...
      //Act
      const objectValue = new StateCategoryValueObject(state);
